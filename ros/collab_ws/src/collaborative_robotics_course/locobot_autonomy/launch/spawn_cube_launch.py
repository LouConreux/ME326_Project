...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        #blue cube 1:
        DeclareLaunchArgument('blue_1_cube_x', default_value='2.5'),
        ...
        #red cube 1:
        DeclareLaunchArgument('red_1_cube_x', default_value='2.5'),
        DeclareLaunchArgument('red_1_cube_y', default_value='1.0'),
        ...
        #green cube 1:
        DeclareLaunchArgument('green_1_cube_x', default_value='2.5'),
        DeclareLaunchArgument('green_1_cube_y', default_value='-0.6'),
        ...
        #yellow cube 1:
        DeclareLaunchArgument('yellow_1_cube_x', default_value='3.0'),
        DeclareLaunchArgument('yellow_1_cube_y', default_value='-1.0'),
