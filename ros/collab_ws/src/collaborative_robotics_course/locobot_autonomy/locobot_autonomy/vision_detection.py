...
class VisionObjectDetector:
    ...
    def get_colored_objects(self, image_bytes):
        ...
        color_ranges = {
            "red": [([0, 100, 100], [10, 255, 255]), ([160, 100, 100], [180, 255, 255])],  # Red wraps around hue space
            "orange": [([11, 100, 100], [25, 255, 255])],
            "yellow": [([26, 100, 100], [35, 255, 255])],
            "green": [([36, 100, 100], [85, 255, 255])],
            "light blue": [([86, 100, 100], [110, 255, 255])],
            "dark blue": [([111, 100, 100], [130, 255, 255])],
            "purple": [([131, 100, 100], [159, 255, 255])]
        }
